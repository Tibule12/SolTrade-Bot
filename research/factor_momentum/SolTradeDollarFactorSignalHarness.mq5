...
bool Summary(){int h=FileOpen(OutputRoot+"\\signal-summary.csv",FILE_WRITE|FILE_CSV|FILE_ANSI|FILE_COMMON,',');if(h==INVALID_HANDLE)return false;FileWrite(h,"field","value");FileWrite(h,"schema","SOLTRADE_PHASE6_V28_SIGNAL_SUMMARY_V1");FileWrite(h,"cohorts",g_cohorts);FileWrite(h,"legs",g_legs);FileWrite(h,"buy",g_buy);FileWrite(h,"sell",g_sell);FileWrite(h,"skips",g_skips);FileWrite(h,"max_tick",TS(g_max));FileWrite(h,"seal_breach",g_seal?"YES":"NO");FileWrite(h,"orders_or_positions","ZERO");FileWrite(h,"pnl_calculated","NO");bool pass=g_ok&&!g_seal&&g_cohorts==17&&g_legs==119;FileWrite(h,"status",pass?"PASS":"FAIL");FileClose(h);return pass;}
